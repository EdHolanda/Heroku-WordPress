<html lang="en">
  <head>
    ...
    <title>
      Freelancer - Edilson Holanda - Informações
    </title>
    <link rel="canonical" href="https://www.torneseumprogramador.com.br">
    ...
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() ?>/assets/styles.css">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Informações Profissionais</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Habilidades</a></li>
